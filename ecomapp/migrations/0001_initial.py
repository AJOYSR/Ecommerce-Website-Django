# Generated by Django 4.1.1 on 2022-11-16 17:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discoubnt', models.PositiveIntegerField()),
                ('total', models.PositiveIntegerField()),
                ('order_status', models.CharField(choices=[('Order Received', 'Order Received'), ('Order Processing', 'Order Processing'), ('Order On the way', 'Order on the way'), ('Order Completed', 'Order Completed'), ('Order Canceled', 'Order Canceled')], max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
